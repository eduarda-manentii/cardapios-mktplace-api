...
public class CategoriaServiceProxy implements CategoriaService {
	...
	@Override
	public Page<Categoria> listarPor(String nome, Status status, TiposDeCategoria tipoDaCategoria,
			Pageable paginacao) {
		return service.listarPor(nome, status, tipoDaCategoria, paginacao);
	}
