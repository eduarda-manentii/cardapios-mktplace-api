...
public class CategoriaController {
	...
	public ResponseEntity<?> alterar(
			@RequestBody
			Categoria categoria) {
		Preconditions.checkArgument(categoria.isPersistido(), "A categoria deve possuir id para a alteração.");
	...
	public ResponseEntity<?> listarPor(
			...
			Status status, 
			@RequestParam("tipo")
			TiposDeCategoria tipoDeCategoria,
			@RequestParam("pagina")
		...
		Page<Categoria> categorias = service.listarPor(nome, status, tipoDeCategoria, paginacao);
